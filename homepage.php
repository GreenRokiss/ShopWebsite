...
<html>
    ...
    <body>
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
          ...
          <div id = "AddPost" style = "position:relative; left:25%; top:10%;">
          <br><br>
             <form action="upload.php" id="addpostform" method="post" enctype="multipart/form-data">
                Select an image to upload: 
                <input type="file" name="fileToUpload" id="fileToUpload"><br><br>
                Caption: 
                <input type="text" name="caption" id="captioninput" style = "width: 20%; height: 20%;"><br><br>
          ...
          <div class="container" right="100%">
			<a href="shop.html"><img src="assets/shoplogo.gif" align="right" style="border-radius: 25px;"></a>
          </div>
          <div id = "posts">
          <?php 
